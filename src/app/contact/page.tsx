      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 p-8 rounded-2xl bg-slate-900 border border-slate-800 space-y-6 shadow-2xl">
              <h2 className="text-2xl font-bold text-white tracking-tight">
                Send an Inquiry or Partnership Proposal
              </h2>

              {submitted ? (
                <div className="p-8 rounded-xl bg-emerald-950/80 border border-emerald-800 text-center space-y-4 animate-in fade-in duration-300">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl text-xs font-bold text-white bg-emerald-700 hover:bg-emerald-600 transition-colors"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-red-500"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-sm text-white focus:outline-none focus:border-red-500 font-mono"
                      >
                        <option value="Technical Collaboration">Technical Collaboration</option>
                        <option value="Data Sharing & Analytics">Data Sharing & Analytics</option>
                        <option value="GIS & Mapping Access">GIS & Mapping Access</option>
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-sm text-white bg-red-600 hover:bg-red-700 transition-colors shadow-lg shadow-red-900/30"
                  >
              ...
              <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 space-y-6">
                ...
                <div className="space-y-4 text-sm text-slate-300">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="block font-bold text-white">Headquarters Address</span>
                      <span className="text-xs text-slate-400">{siteConfig.contact.location}</span>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="block font-bold text-white">Department Email</span>
                      <a href={`mailto:${siteConfig.contact.email}`} className="text-xs text-red-400 hover:underline">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-slate-400">
                        National Toll-Free: <strong className="text-red-400 font-mono">{siteConfig.contact.emergencyLine}</strong>
                      </span>
                      <span className="block text-xs text-slate-400">{siteConfig.contact.phone}</span>
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-slate-800 flex items-center gap-2 text-xs font-semibold text-slate-300">

      ...
      <section className="py-24 bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950 text-white border-t border-slate-800 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/people"
              className="inline-flex items-center gap-2 px-7 py-4 rounded-xl font-semibold text-sm text-slate-200 bg-slate-900 hover:bg-slate-800 border border-slate-800 transition-all hover:border-slate-700"
            >

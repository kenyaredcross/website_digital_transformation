import { Handshake, Globe, ShieldCheck, Sparkles, Coins } from "lucide-react";
            ...
            <div className="flex-1 space-y-7">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.05]">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 text-red-600 dark:text-red-500">transformation.</span>
                  <span
                    aria-hidden
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 leading-relaxed">
                Collaborating with global tech pioneers, UN agencies, research institutions, and
                telecommunications networks to scale digital humanitarian impact.
              </p>

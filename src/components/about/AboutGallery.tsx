...
export function AboutGallery() {
  ...
  return (
    <section className="py-24 bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 relative transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {distroImages.map((img) => (
            <div
              ...
              className="group relative h-80 rounded-2xl overflow-hidden bg-blue-950 border border-blue-900/80 cursor-pointer hover:border-red-500/50 transition-all duration-300 shadow-lg hover:shadow-red-500/10 flex flex-col justify-end"
            >
              ...
              {/* Strong navy shade at bottom for text readability on bright images */}
              ...
              {/* Extra solid navy strip right behind the caption text for maximum contrast */}
              ...
              <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
                <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-red-400 bg-blue-950/80 backdrop-blur-md px-2.5 py-1 rounded-full border border-red-800/40">
                  {img.category}
                </span>
                <div className="p-1.5 rounded-full bg-blue-950/80 text-slate-400 group-hover:text-white group-hover:bg-red-600 transition-colors">
              ...
              <div className="relative z-10 p-5 space-y-1.5">
                <h3 className="text-base font-bold text-white drop-shadow-lg group-hover:text-red-400 transition-colors leading-snug">
                  {img.title}
                </h3>
                <p className="text-xs text-slate-200 drop-shadow-md line-clamp-2 leading-relaxed">
                  {img.caption}
                </p>
              </div>
            </div>
      ...
      {selectedImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-blue-950/90 backdrop-blur-md">
          <div
            className="fixed inset-0"
            onClick={() => setSelectedImage(null)}
          />
          <div className="relative z-10 max-w-4xl w-full bg-blue-950 border border-blue-900 rounded-3xl overflow-hidden shadow-2xl space-y-0">
            {/* Modal Header */}
            <div className="p-4 sm:p-6 border-b border-blue-900 flex items-center justify-between bg-blue-950/60">
              ...
              <button
                onClick={() => setSelectedImage(null)}
                className="p-2 rounded-full text-slate-400 hover:text-white hover:bg-blue-900 transition-colors"
            ...
            {/* Modal Image */}
            <div className="relative w-full h-[60vh] max-h-[500px] bg-blue-950">
              <Image
            ...
            <div className="p-6 bg-blue-950 border-t border-blue-900 space-y-2">

...
export function Footer() {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-slate-950 text-slate-700 dark:text-slate-300 border-t border-slate-200 dark:border-slate-800 transition-colors duration-300">
      {/* Top Banner */}
      <div className="bg-red-700 dark:bg-red-700/90 text-white py-4 px-4 text-center text-xs sm:text-sm font-medium tracking-wide">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="pt-2 space-y-2 text-xs text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href={`mailto:${siteConfig.contact.email}`} className="hover:text-red-600 dark:hover:text-white transition-colors">
                  {siteConfig.contact.email}
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-red-600 dark:text-red-500 shrink-0" />
                <span>Emergency Hotline: <strong className="text-red-600 dark:text-red-400 font-mono">{siteConfig.contact.emergencyLine}</strong></span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-slate-900 dark:text-white text-xs font-bold uppercase tracking-widest border-l-2 border-red-600 dark:border-red-500 pl-3">
              Navigation
            </h3>
            <ul className="space-y-2.5 text-sm">
              {mainNav.map((nav) => (
                <li key={nav.href}>
                  <Link
                    href={nav.href}
                    className="text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors inline-block"
                  >
                    {nav.title}
                  </Link>
                </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/what-we-do/digital-products" className="text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors">
                  Digital Products & Platforms
                </Link>
              </li>
              <li>
                <Link href="/what-we-do/data-services" className="text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors">
                  Data Services & Analytics
                </Link>
              </li>
              <li>
                <Link href="/what-we-do/gis-spatial" className="text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors">
                  GIS & Spatial Intelligence
                </Link>
              </li>
              <li>
                <Link href="/what-we-do/innovation-ai" className="text-slate-600 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-1 flex items-center gap-2 text-xs font-semibold text-slate-800 dark:text-slate-300">
            ...
            <div className="pt-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 underline font-medium"
              >
                www.redcross.or.ke
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-900 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/contact" className="hover:text-slate-800 dark:hover:text-slate-300">
              Get in Touch
            </Link>
          </div>
        </div>

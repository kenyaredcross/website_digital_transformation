...
function PartnerCard({
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 flex flex-col"
    >
      ...
      <div className="relative z-10 flex flex-col flex-1 p-6 gap-4">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <a
            ...
            className="shrink-0 p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all duration-200"
          >
